...
<!-------------------------- Start your work below ---------------------------->
I choose the parking_meters and vancouver_trees. Both dataset are collected in Vancouver...
<!----------------------------------------------------------------------------->

1.4 Time for the final decision! Going back to the beginning, it's important to have an *end goal* in mind. For example, if I had chosen the `titanic` dataset for my project, I might've wanted to explore the relationship between survival and other variables. Try to think of 1 research question that you would want to answer with each dataset. Note them down below, and make your final choice based on what seems more interesting to you!

<!-------------------------- Start your work below ---------------------------->
For the vancouver_trees dataset, I am interested in does different type of tree have same diameters.
<!----------------------------------------------------------------------------->
...
maple_diameter_dist<-
  ...
  ggtitle("Distribution of PYRUS Diameters") +
  xlab("Diameters(inch)")
maple_diameter_dist
```
...
<!--- *****START HERE***** --->
1. Does the genus of tree affect the average diameters of tree?
2. Does the sampling distribution of sample means for the diameter of PYRUS tree has the similar mean of the population mean?
3. What is the most planted tree(genus) in Vancouver?
4. Does the outliers of diameters affect the summary statistic a lot?
...
mean_sampling
# The sampling distribution of sample means for the diameter of PYRUS tree has the similar mean of the population mean. 11.6113 compared to 11.6412(calculate in Q1).
...
pyrus_sampling_dist_3 <-
  ...
  xlab("Sample Mean of Pyrus Diameter(cm)")
pyrus_sampling_dist_3
# The bin width = 0.1 is the best one.....
```
...
# When we ignore the outliers, it affect our summary statistic a lot. Sd and mean have more effect than median, they are sensitive to extreme value.
tree_nonoutlier_acergraph<- 
  ...
  ggtitle("Distribution of Diameters(cm) of Acer in Vanouuver")
tree_nonoutlier_acergraph
#Without outliers, the graph more clear compared to the graph in research question1.
```
